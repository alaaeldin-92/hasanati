                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            setState(() {
                              _model.choice = 'Sign In';
                            });
                          },
                          child: Container(
                            decoration: BoxDecoration(
                              color: _model.choice == 'Sign In'
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            setState(() {
                              _model.choice = 'Sign Up';
                            });
                          },
                          child: Container(
                            decoration: BoxDecoration(
                              color: _model.choice == 'Sign Up'
                                  ? FlutterFlowTheme.of(context)
                                      .secondaryBackground
                                  : Colors.transparent,
                              borderRadius: BorderRadius.circular(50.0),
                        ...
                        children: [
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    if (_model.authErrorSignIn != null &&
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Theme(
                                            ...
                                            child: Checkbox(
                                              value: _model
                                                  .checkboxSignInValue ??= true,
                                              onChanged: (newValue) async {
                                                setState(() =>
                                                    _model.checkboxSignInValue =
                                                        newValue!);
                                              },
                                              activeColor: Color(0xFF009BDD),
                                              checkColor:
                                                  FlutterFlowTheme.of(context)
                                                      .info,
                                            ),
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'mcgkyfjd' /* Don't have an account? Sign Up */,
                                ),
                        ...
                        children: [
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    if (_model.authErrorSignUp != null &&
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'g7o705qc' /* Already have an account? Sign ... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
